...
6. Ship with `bash scripts/open-pr.sh --auto-merge`; it creates or updates the PR, watches the review/check loop, addresses actionable feedback, merges when approved, and syncs the default branch.
