...
assert_not_contains "$TOUCHSTONE_ROOT/scripts/open-pr.sh" "prefer bundling related work into one PR"
assert_not_contains "$TOUCHSTONE_ROOT/scripts/open-pr.sh" "bundle into one PR"
