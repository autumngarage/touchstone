...
- **Count fix rounds; at three, take an exit** — one push of review-driven change is one round. Exits: merge-answered, revert-simplify, split, close-replan; more rounds is not one. The budget follows the capability; closing or renaming never resets it.
