...
- **Isolate file-writing subagents** — use dedicated worktrees and disjoint files; remove one only after its task is terminal and its final result reaches the parent.
