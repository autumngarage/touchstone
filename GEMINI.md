...
9. **Clean up before the session ends.** Checkout on the default branch at origin; your worktree, local branch, and merged remote branch gone; no untracked residue; tracker item in its terminal state. `touchstone cleanup check` must report nothing.
