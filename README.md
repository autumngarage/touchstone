...
versioned CLI entrypoint, including plan-first adoption and explicit upgrade
planning. Homebrew distribution remains a separate replacement capability;
none may restore background propagation.
