...
- **Review cannot amend the approved scope; answering is not implementing.** Fix diff-created regressions and violations of recorded acceptance criteria. Answer and route real out-of-scope findings without changing the PR. If review starts widening scope, stop implementation and further requests on that shape; narrow, split along independently approved criteria, or redesign.
