...
- **One review request per head; answered findings satisfy the gate** (issue #751) — after resolving threads, rerun `merge-pr.sh`, do NOT re-request. Only a body-only finding takes `open-pr.sh --fresh-review`.
