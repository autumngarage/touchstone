...
- **Templates are legacy transition inputs, not the future contract.** Nothing currently copies them. They describe the frozen downstream shape and remain available for the consumer audit; do not extend their detection, setup, or vendored-runner model. `principles/product-contract.md` defines the replacement boundary.
