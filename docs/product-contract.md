...
| Claim work and validate tracker references | Configured tracker adapter | Tracker-neutral claim/validation contract | GitHub- and Linear-backed fixtures distinguish valid input from unavailable transport |
...
- `.touchstone.toml` declares its schema version, exact validation commands,
  ...
  claim/validation configuration, references, and outcomes.
