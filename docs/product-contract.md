...
| Claim and reconcile work | Configured tracker adapter | Tracker-neutral claim/reconciliation contract | GitHub- and Linear-backed fixtures verify tracker effects without reimplementing provider grammar |
...
- `.touchstone.toml` declares its schema version, exact validation commands,
  ...
  claim/reconciliation configuration, references, and outcomes.
