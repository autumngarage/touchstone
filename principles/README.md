...
| File | Summary |
|------|---------|
| [engineering-principles.md](engineering-principles.md) | Hard requirements: no band-aids, narrow interfaces, no silent failures, every retained fix gets a test, recoverable irreversibles, compatibility at boundaries |
